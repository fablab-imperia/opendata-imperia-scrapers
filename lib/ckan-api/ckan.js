...
class Ckan {
    ...
    createOrganization(createParams) {
        return this.makePromiseForAction('organization_create', createParams);
    }
    deleteOrganization(id) {
        return this.makePromiseForAction('organization_purge', id);
    }
    getDatasets(limit, offset) {
        return this.makePromiseForAction('package_list', { limit: limit, offset: offset });
    }
    ...
    deleteDataset(id) {
        return this.makePromiseForAction('package_delete', id);
    }
    createDataForDataset(params) {
        return this.makePromiseForAction('datastore_create', params);
    }
}
exports.Ckan = Ckan;
